...
import base_gamepad.AnimatedActor;
...
public class CheeseLevel extends BaseScreen {
    ...
    public void create() {
        ...
        floor = new BaseActor();
        floor.setTexture(new Texture(Gdx.files.internal("assets/chapter3/cheese_please/tiles-800-800.jpg")));
        floor.setPosition(0,0);
        mainStage.addActor(floor);

        cheese = new BaseActor();
        cheese.setTexture(new Texture(Gdx.files.internal("assets/chapter3/cheese_please/cheese.png")));
        ...
        mousey.setTexture(new Texture(Gdx.files.internal("assets/chapter3/cheese_please/mouse.png")));
        mousey.setPosition(20,20);
        mousey.setOrigin(mousey.getWidth() / 2, mousey.getHeight() / 2);
        mainStage.addActor(mousey);

        winText = new BaseActor();
        winText.setTexture(new Texture(Gdx.files.internal("assets/chapter3/cheese_please/you-win.png")));
        ...
        for (int i = 0; i < 4; i++) {
            String fileName = "assets/chapter3/cheese_please/mouse" + i + ".png";
