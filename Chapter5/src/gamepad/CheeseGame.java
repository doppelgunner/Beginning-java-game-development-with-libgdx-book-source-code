...
public class CheeseGame extends BaseGame
{
    ...
    {  
        ...
        BitmapFont uiFont = new BitmapFont(Gdx.files.internal("assets/chapter5/cheeseplease/cooper.fnt"));
        ...
        Texture upTex = new Texture(Gdx.files.internal("assets/chapter5/cheeseplease/ninepatch-1.png"));
        skin.add("buttonUp", new NinePatch(upTex, 26,26,16,20));
        uiTextButtonStyle.up = skin.getDrawable("buttonUp");
        
        Texture overTex = new Texture(Gdx.files.internal("assets/chapter5/cheeseplease/ninepatch-2.png"));
        ...
        Texture downTex = new Texture(Gdx.files.internal("assets/chapter5/cheeseplease/ninepatch-3.png"));
